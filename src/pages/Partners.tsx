...
export default function Partners() {
    const [partners, setPartners] = React.useState<Parner[]>([
        {
            ...
            description: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Porro eligendi placeat est unde voluptatibus ex, aspernatur repellat tenetur autem fuga corporis non amet voluptatem laboriosam dignissimos vitae dolores esse. Odit.'
        },
        {
            name: 'Partner 2',
    ...
    return (
        <Wrapper className='sm:px-0 px-6'>
            <h2 className="text-own-green text-left font-semibold sm:text-4xl text-2xl mb-3">PARCEIROS</h2>
            <div className='flex flex-col gap-6'>
                {
                    partners.map((partner) => (
                        <div key={partner.name} className='flex sm:gap-8 gap-2 flex-col sm:flex-row'>
                            <img src={partner.image} alt={partner.name} className='rounded-lg aspect-video' />
                            <div>
