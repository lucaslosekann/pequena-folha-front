    ...
    return (
        <Wrapper className="flex flex-col gap-8 sm:px-0 px-3">
            <div className="flex flex-col sm:flex-row justify-between sm:text-2xl text-lg sm:gap-0 gap-3">
                <div className="sm:w-[49%] flex flex-col sm:gap-5 gap-2">
                    <h2 className="text-own-green font-semibold sm:text-4xl text-2xl">PROJETO PEQUENA FOLHA</h2>
                    <p>
                ...
                <iframe className="sm:w-[49%] w-full aspect-video" src="https://www.youtube.com/embed/HkdOvsDse3o?si=J9fkPhgursk5loq9" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
            </div>
            <div className="sm:text-2xl text-lg flex flex-col sm:gap-5 gap-2">
                <h2 className="text-own-green font-semibold sm:text-4xl text-2xl">O QUE É O PEQUENA FOLHA</h2>
                <p>
            ...
            <div className="sm:text-2xl text-lg flex flex-col sm:gap-5 gap-2">
                <h2 className="text-own-green font-semibold sm:text-4xl text-2xl">HISTÓRICO DO PROJETO</h2>
                <p>
